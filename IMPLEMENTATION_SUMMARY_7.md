...
|---|---|
| `IconConverter.kt` | `ALPHA_THRESHOLD`, `QUANTIZE_SHIFT`, `QUANTIZE_BITS`, `LUMINANCE_R_WEIGHT`, `LUMINANCE_G_WEIGHT`, `LUMINANCE_B_WEIGHT`, `LUMINANCE_THRESHOLD`, `BYTE_ALIGNMENT`, `BITS_PER_BYTE`, `MAX_DRAWABLE_SIZE`, `MIN_DRAWABLE_SIZE`, `BYTE_ALIGN_MASK`, `BYTE_SHIFT` |
