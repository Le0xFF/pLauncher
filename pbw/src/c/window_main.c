...
static char         s_index_buf[INDEX_BUFFER_SIZE];
...
static void window_load(Window *window)
{
    ...
    s_icon_bitmap = gbitmap_create_blank(GSize(APP_ICON_WIDTH, APP_ICON_HEIGHT), PBL_IF_COLOR_ELSE(GBitmapFormat8Bit, GBitmapFormat1Bit));
